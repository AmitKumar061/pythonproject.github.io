...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(410, 327)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(80, 60, 241, 31))
        font = QtGui.QFont()
        ...
        self.openbtn.setGeometry(QtCore.QRect(140, 230, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.open_cb.setGeometry(QtCore.QRect(90, 140, 211, 51))
